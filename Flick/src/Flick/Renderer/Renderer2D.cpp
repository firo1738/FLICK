...
namespace Flick
{
	...
	void Renderer2D::Init()
	{
		...
		s_Data.QuadVertexPositions[0] = { -0.5f, -0.5f, 0.0f, 1.0,};
		s_Data.QuadVertexPositions[1] = {  0.5f, -0.5f, 0.0f, 1.0, };
		s_Data.QuadVertexPositions[2] = {  0.5f,  0.5f, 0.0f, 1.0, };
		s_Data.QuadVertexPositions[3] = { -0.5f,  0.5f, 0.0f, 1.0, };
	}
